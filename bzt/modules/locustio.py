...
from bzt.engine import ScenarioExecutor, Scenario, HavingInstallableTools, SelfDiagnosable
...
class LocustIOExecutor(ScenarioExecutor, WidgetProvider, HavingInstallableTools, SelfDiagnosable):
    def __init__(self):
